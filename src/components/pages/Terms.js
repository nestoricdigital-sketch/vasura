...
const Terms = () => {
  return (
    <div className="w-full py-12 px-6 md:px-8 lg:px-24">
      <Link to="/">
      ...
      <div className=" p-6 bg-[#36454F] flex md:justify-between items-center rounded-lg mb-6 text-white">
        ...
        <div>
          ...
          <p>
            <span className="text-slate-400"> Last Updated:</span> November 2025
          </p>
        </div>
      </div>
      <div className=" rounded-2xl  p-2 sm:p-0">
        ...
        <section className="mb-8">
          <p className="text-gray-700 leading-relaxed">
            Welcome to <strong>Vasura Virtual Experience</strong> (“we,” “our,”
          ...
          text={
            <>
              ...
              <ul className="list-disc list-inside mt-3 space-y-2">
                ...
                <li>
                  Vasura reserves the right to refuse or reschedule projects for
                  reasons including safety, location access, or inappropriate
                  content.
                </li>
              </ul>
            </>
          ...
          text={
            <>
              ...
              <p className="mt-3">
                ...
                digital platforms. Late payments beyond 7 working days may incur
                a reactivation fee. Refunds are not available once the project
                has been initiated or completed, except for technical or
                operational failures from our side.
              </p>
            </>
          }
        />
        ...
        <Section
          ...
          text={
            <>
              Upon full payment, the client gains the right to use the delivered
              virtual tour or media content for promotional purposes.
              <br />
              <br />
          ...
          text={
            <>
              ...
              <ul className="mt-3 space-y-1">
                ...
                <li>
                  Address: 1220 4th Ward D Cross Road, Doddaballapur, Bangalore,
                  North-561203
                </li>
              </ul>
            </>
