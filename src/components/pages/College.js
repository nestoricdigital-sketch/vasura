  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 right-0 flex flex-col items-end gap-3 z-20">
        ...
        {/* Fullscreen button */}
        <div className="icon-row flex justify-center mr-0 md:mr-8  items-center ">
          <span
            onClick={() => setShowShareMenu(!showShareMenu)}
            className="tooltip px-4 py-2 rounded-md font-medium transition cursor-pointer"
          >
